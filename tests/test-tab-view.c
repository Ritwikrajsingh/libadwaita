      ...
      char *argv[])
{
  ...
  g_test_add_func ("/Handy/TabView/n_pages", test_adw_tab_view_n_pages);
  g_test_add_func ("/Handy/TabView/n_pinned_pages", test_adw_tab_view_n_pinned_pages);
  g_test_add_func ("/Handy/TabView/default_icon", test_adw_tab_view_default_icon);
  g_test_add_func ("/Handy/TabView/menu_model", test_adw_tab_view_menu_model);
  g_test_add_func ("/Handy/TabView/shortcut_widget", test_adw_tab_view_shortcut_widget);
  g_test_add_func ("/Handy/TabView/pages", test_adw_tab_view_pages);
  g_test_add_func ("/Handy/TabView/select", test_adw_tab_view_select);
  g_test_add_func ("/Handy/TabView/add_basic", test_adw_tab_view_add_basic);
  g_test_add_func ("/Handy/TabView/add_auto", test_adw_tab_view_add_auto);
  g_test_add_func ("/Handy/TabView/reorder", test_adw_tab_view_reorder);
  g_test_add_func ("/Handy/TabView/reorder_first_last", test_adw_tab_view_reorder_first_last);
  g_test_add_func ("/Handy/TabView/reorder_forward_backward", test_adw_tab_view_reorder_forward_backward);
  g_test_add_func ("/Handy/TabView/pin", test_adw_tab_view_pin);
  g_test_add_func ("/Handy/TabView/close", test_adw_tab_view_close);
  g_test_add_func ("/Handy/TabView/close_other", test_adw_tab_view_close_other);
  g_test_add_func ("/Handy/TabView/close_before_after", test_adw_tab_view_close_before_after);
  g_test_add_func ("/Handy/TabView/close_signal", test_adw_tab_view_close_signal);
  g_test_add_func ("/Handy/TabView/close_select", test_adw_tab_view_close_select);
  g_test_add_func ("/Handy/TabView/transfer", test_adw_tab_view_transfer);
  g_test_add_func ("/Handy/TabPage/title", test_adw_tab_page_title);
  g_test_add_func ("/Handy/TabPage/tooltip", test_adw_tab_page_tooltip);
  g_test_add_func ("/Handy/TabPage/icon", test_adw_tab_page_icon);
  g_test_add_func ("/Handy/TabPage/loading", test_adw_tab_page_loading);
  g_test_add_func ("/Handy/TabPage/indicator_icon", test_adw_tab_page_indicator_icon);
  g_test_add_func ("/Handy/TabPage/indicator_activatable", test_adw_tab_page_indicator_activatable);
  g_test_add_func ("/Handy/TabPage/needs_attention", test_adw_tab_page_needs_attention);
